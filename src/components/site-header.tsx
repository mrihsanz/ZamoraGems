      ...
      <div className="mx-auto flex w-full max-w-6xl items-center gap-4 px-4 py-3 sm:px-6">
        ...
        <div className="hidden flex-1 md:flex">
          ...
          <input
            ...
            className="w-full rounded-full border border-zinc-300 px-4 py-2 text-sm outline-none ring-amber-500 transition focus:ring-2"
          />
        </div>
        ...
        <div className="ml-auto flex items-center gap-2 text-sm">
          <Link
            href="/account"
            className="rounded-full border border-zinc-300 px-3 py-1.5 hover:border-amber-500 hover:text-amber-700"
          >
            Login
          </Link>
          <button
            type="button"
            className="rounded-full bg-amber-500 px-3 py-1.5 font-medium text-black"
          >
            Cart (0)
          </button>
        </div>
